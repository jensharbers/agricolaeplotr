...
```{r}
fullFact2 <- full_factorial(setfactors = NULL, reps = 5, l = 1, type = 2,
                            plotNumber = c(101,1001,2001),
                            continuous = FALSE,
                            planter = "serpentine",
                            seed = 326,
                            locationNames = c("Loc1"),
                            data = data_factorial)

fullFact2$infoDesign

fullFact2$fieldBook$COLUMN <-  rep(1:length(unique(fullFact2$fieldBook$TRT_COMB)),times=max(fullFact2$fieldBook$REP))

full_control_positions(fullFact2$fieldBook,x="REP",y="COLUMN",
                       factor_name = "TRT_COMB ",
                       labels="PLOT", shift_x= -1,shift_y = -1)

plot_fieldhub(fullFact2,x="REP",y="COLUMN",
              factor_name = "TRT_COMB ",
